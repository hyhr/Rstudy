...
import com.r.study.elasticsearch.conditions.config.ElasticSearchProperties;
...
public class ServiceImpl<T> implements IService<T> {
    ...
    public void init() {
        ...
        //TODO 断言需要注解
        com.r.study.elasticsearch.conditions.annotation.Alias annotation = entityClass.getAnnotation(com.r.study.elasticsearch.conditions.annotation.Alias.class);
        if (annotation != null) {
